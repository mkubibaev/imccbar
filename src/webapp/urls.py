...
urlpatterns = [
    ...
    path('multimedia', views.MultimediaView.as_view(), name='media_list'),
    path('multimedia/photogallery/<int:pk>', views.PhotoGalleryDetailView.as_view(), name='album_detail'),
    path('multimedia/video/<int:pk>', views.VideDetailView.as_view(), name='video_detail'),
